...
public class CodiceFiscaleActivity extends AppCompatActivity implements View.OnClickListener {

    TextView txt_link1, txt_file1, txt_file2;
    ...
    private void downloadFile() {
        ...
        if (ConnectivityHelper.isConnectingToInternet(getApplicationContext())) {
            ...
            showProgressDialog(CodiceFiscaleActivity.this);
            APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
            Call<ResponseBody> call = apiInterface.getCodiceFiscale();
                ...
                public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            try {
                                FileCreate fileCreate = new FileCreate(CodiceFiscaleActivity.this);
                                String appName = "CodiceFiscalExampleForm";
                                ...
                                try {
                                    ...
                                    Uri uri = FileProvider.getUriForFile(CodiceFiscaleActivity.this, BuildConfig.APPLICATION_ID + ".provider", file);
    ...
    private void downloadFile2() {
        ...
        if (ConnectivityHelper.isConnectingToInternet(getApplicationContext())) {
            ...
            showProgressDialog(CodiceFiscaleActivity.this);
            APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
            Call<ResponseBody> call = apiInterface.getCodiceFiscale1();
